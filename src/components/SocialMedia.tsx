...
export const socialMediaProfiles = [
  {
    title: 'Instagram',
    href: 'https://www.instagram.com/hephasoft/',
    icon: InstagramIcon,
  },
  {
    title: 'Facebook',
    href: 'https://www.facebook.com/profile.php?id=61572637912894',
    icon: FacebookIcon,
  },
  {
    title: 'YouTube',
    href: 'https://www.youtube.com/@hephasoft',
    icon: GitHubIcon,
  },
]
...
export function SocialMedia({
  ...
  return (
    <ul
      ...
      className={clsx(
        'flex gap-x-10',
        invert ? 'text-moonstone' : 'text-accent',
        className,
      )}
    >
      {socialMediaProfiles.map((socialMediaProfile) => (
        <li key={socialMediaProfile.title}>
          <Link
            ...
            className={clsx(
              'transition',
              invert ? 'hover:text-moonstone/80' : 'hover:text-accent/70',
            )}
          >
